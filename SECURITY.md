...
- The optional Discourse discussion panel MVP uses plain links into the private Discourse instance for any selected repository file and does not store a separate Discourse API credential in the browser.
